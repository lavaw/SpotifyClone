...
class PlaylistViewController: UIViewController {
    ...
    private var viewModels = [RecommndedTrackListCellViewModel]()
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(PlaylistHeadeCollectionReusableView.self,
                                forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader,
                                withReuseIdentifier: PlaylistHeadeCollectionReusableView.identifier)
            ...
            DispatchQueue.main.async {
                ...
                case .success(let model):
                    ...
                    self?.viewModels = model.tracks.items.compactMap({
                        RecommndedTrackListCellViewModel(name: $0.track.name,
...
extension PlaylistViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        guard let header = collectionView.dequeueReusableSupplementaryView(ofKind: kind,
                                                                           withReuseIdentifier: PlaylistHeadeCollectionReusableView.identifier,
                                                                           for: indexPath) as? PlaylistHeadeCollectionReusableView,
...
extension PlaylistViewController: PlaylistHeadeCollectionReusableViewDelegate {
